...
//============================================================================
module mla_attn_fp8_multiseq_tb;
    ...
    initial begin
        ...
        one_case( 11, 0, 0, 2);   // S=2 pos=0 (RoPE identity), both seqs full window
        one_case(101, 0, 7, 2);   // S=2 pos>0
        one_case(211, 1, 4095, 2);// wide-range, large pos
        one_case(321, 0, 3, 1);   // S=1 (one key per seq)

...
- **It is NOT the trading hot path.** Interactive research speed — measured-proxy design points [EST]
  span ~0.5–1 tok/s (NVMe-only prove-it rung) to ~13–47 on the funded custom board, ≈80 on the

...
unittests:
	...
	@$(IVERILOG) $(IFLAGS) -o $(BUILD_DIR)/glm_fp8_soc_ms_sim test/glm_fp8_soc_ms_tb.v src/glm_fp8_soc_ms.v src/glm_model_fp8.v src/kv_cache_pager.v src/glm_decoder_block_fp8.v src/mla_attn_fp8.v src/swiglu_expert_fp8.v src/moe_router_fp8.v src/glm_matmul_fp8.v src/rmsnorm_unit.v src/rope_interleave_unit.v src/glm_softmax.v src/dsa_indexer.v src/topk_select.v src/glm_act.v src/glm_matmul_pipe.v src/sampler.v src/glm_fp_pipe.v

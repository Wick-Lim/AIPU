...
> §5c — presumes a MAC array sized to consume 1.54 TB/s, i.e. **~6.6K lanes @490MHz** per §3 (at the
> checkpoint's measured 0.62 B/param); a smaller
